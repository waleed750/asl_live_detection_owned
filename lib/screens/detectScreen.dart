import 'package:asl_live_detection_owned/helpers/app_helper.dart';
import 'package:asl_live_detection_owned/helpers/camera_helper.dart';
import 'package:asl_live_detection_owned/helpers/tflite_helper.dart';
...
class DetectScreen extends StatefulWidget {
  DetectScreen({required this.title}) ;
...
class _DetectScreenState extends State<DetectScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: outputs!= null ?FutureBuilder<void>(
